...
import {get_local_user_data} from "@/data/functions/ptero/api";
...
export default async function Dash() {
    ...
    const ptero_user_data = await get_local_user_data()
        ...
        <div className={styles.Container}>
            <section>
                ...
                <div className={styles.Stats}>
                    <StatsCard name={'伺服器'} used={1} max={ptero_user_data.res.servers} unit={'個'}>
                    ...
                    <StatsCard name={'CPU'} used={100} max={ptero_user_data.res.cpus} unit={'%'}>
                    ...
                    <StatsCard name={'記憶體'} used={512} max={ptero_user_data.res.memories} unit={'mb'}>
                    ...
                    <StatsCard name={'磁碟'} used={1024} max={ptero_user_data.res.discs} unit={'mb'}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                            <path
